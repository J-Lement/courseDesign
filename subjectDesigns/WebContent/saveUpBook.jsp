                                ...
                                <div class="col-md-8">
                           			<div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">书籍ID(请填写)</span>
                                            </div>
                                    ...
                                    <div class="input-group mb-3">
                                            ...
                                            <input type="text" readonly="true" name="bookName" class="form-control" value="${bean.bName }">
                                    </div>
                                    <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">书籍作者</span>
                                            </div>
                                            <input type="text" readonly="true" name="bookAuthor" class="form-control" value="${bean.bAuthor }">
                                    </div>
                                    <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">书籍简介</span>
                                            </div>
                                            <input type="text" readonly="true" name="bookInfo" class="form-control" value="${bean.bInfo }">
                                    </div>
                                    <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">所属课程</span>
                                            </div>
                                            <input type="text" readonly="true" name="bookSub" class="form-control" value="${bean.bSub}">
                                    </div>
                                    <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">书籍文件(请选择)</span>
                                            </div>
