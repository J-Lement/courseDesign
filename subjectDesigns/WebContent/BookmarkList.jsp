...
<head>
    ...
    <script type="text/javascript">
        ...
        function Clock(time) {
            setTimeout(function(){ alert("看书啦"); }, time*1000);
        }
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div id="toolbar"  style="text-align:right;margin-right:10px;">
                                    <input class="btn btn-rounded btn-info" type="button"  value=" 提醒 " onclick="Clock(${rTime})" />
                                </div>
                            </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <c:forEach items="${list }" var="bean">
                                        ...
                                        <tr>
                                            ...
                                            <td>${bean.reading} </td>
                                            <td>${bean.rTime}</td>
                                            <td><a href='BookMarkDel?bookId=${bean.bookId}'>删除 </a>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
    ...
    <%--<div id="rightDiv">--%>
        <%--<div id="searchBox">--%>
            <%--<form name="frm" action="FileList">--%>
                <%--书籍名称：<input type="text" name="title" value="<c:out value="${title}"></c:out>">--%>
