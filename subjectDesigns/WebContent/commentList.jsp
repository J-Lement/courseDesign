                                ...
                                <table class="table table-striped">
                                    ...
                                    <c:forEach items="${list }" var="bean">
                                        ...
                                        <tr>
                                                ...
                                                <td height="40"><a href='CommentNextList?cId=${bean.getCld()}'>回复</a></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
...
<%--<div>--%>
    <%--<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="border">--%>
        <%--<tr>--%>
            <%--<td align="center" valign="middle" bgcolor="#FF9999" class="td_right"><font size="+3">&nbsp;--%>
                <%--<strong>书籍详情</strong></font></td>--%>
        <%--</tr>--%>
        <%--<tr>--%>
            <%--<td height="240"  class="td_right">描述</td>--%>
        <%--</tr>--%>
        <%--<tr>--%>
    ...
    <%--</table>--%>
        ...
        <%--<table width="100%">--%>
            <%--<tr>--%>
                <%--<td height="30" colspan="3" class="td_right"><strong>评论: </strong></td>--%>
            <%--</tr>--%>
            <%--<form action="CommentAdd"  method="get" />--%>
            <%--<tr>--%>
                <%--<td>--%>
                    <%--<input id="txtCon" type="text" name="content"  value=""/>--%>
