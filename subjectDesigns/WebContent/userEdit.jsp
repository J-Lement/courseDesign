        ...
        <div class="content">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                        <form action="UserEditDo" class="form" method="post">
                                ...
                                <div class="col-md-8">
                           			<div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">用户ID(不可修改)</span>
                                            </div>
                                            <input type="text" readonly="true" name="userId" class="form-control" value="${userBean.userId }">
                                    </div>
                                    <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">用户姓名</span>
                                            </div>
                                            <input type="text" name="userName" class="form-control" value="${userBean.userName }">
                                    </div>
                                    <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">用户密码</span>
                                            </div>
                                            <input type="text" name="password" class="form-control" value="${userBean.password }">
                                    </div>
                                    <div class="input-group mb-3">
                                            <select id="single-select" class="form-control" name="userType">
                                                <option selected disabled style="display: none;" value="">用户类型</option>
                                                <option value="学生" <c:if test="${userBean.userType == '学生' }">${"selected"}</c:if>>学生</option>
												<option value="管理员" <c:if test="${userBean.userType == '管理员' }">${"selected"}</c:if>>管理员</option>
                                            </select>
                                    </div>
                                    <div class="card-body">
