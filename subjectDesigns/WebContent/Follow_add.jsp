                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <td><a href='FollowAdd?subId=${bean.subId}&userId=${userId}'>关注 </a></td>
                                    </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
...
<%--<div id="main">--%>
    ...
    <%--<div id="leftDiv">--%>
        ...
        <%--<ul id="nav">--%>
            ...
            <%--<li><a href="FollowList?user=${userId}">关注列表</a></li>--%>
    ...
    <%--<div id="rightDiv">--%>
        <%--<div id="searchBox">--%>
            <%--<form name="frm" action="BookSearch">--%>
                <%--书籍名称：<input type="text" name="book_name" value="<c:out value="${userId}"></c:out>">--%>
        ...
        <%--<div id="dataArea">--%>
            <%--<table width="100%" border="1" style="border-collapse:collapse">--%>
                ...
                <%--<c:forEach items="${list }" var="bean">--%>
                    <%--<tr>--%>
                        <%--<td>${bean.subName }</td>--%>
                            <%--&lt;%&ndash;<td><img src="${bean.attach}" ></td>&ndash;%&gt;--%>
                        <%--<td><a href='FollowAdd?subId=${bean.subId}'>关注 </a></td>--%>
                        <%--<td></td>--%>
                        <%--<td></td>--%>
                    <%--</tr>--%>
                <%--</c:forEach>--%>
