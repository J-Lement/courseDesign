...
<div class="page-wrapper">
    ...
    <div class="main-container">
        ...
        <div class="content">
            <div class="container">
             <form name="frm" action="CheckBook">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                           ...
                           <div class="row">
                                ...
                                <div class="col-md-3">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="bSub" class="form-control" value="${bSub }">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                        <div class="form-group">
                                            <select id="single-select" class="form-control" name="ifCheck">
                                                <option selected disabled style="display: none;" value="">是否审核</option>
                                ...
                                <div class="row p-1">
                                    <div class="col-md-12">
                                        <table class="table">
                                            <thead>
                                            <tr>
                                                <th class="border-0 text-uppercase small font-weight-bold">书ID</th>
                                                <th class="border-0 text-uppercase small font-weight-bold">上传者ID</th>
                                                ...
                                                <th class="border-0 text-uppercase small font-weight-bold">书籍内容</th>
                                                <th class="border-0 text-uppercase small font-weight-bold">所属课程</th>
                                                <th class="border-0 text-uppercase small font-weight-bold">是否审核</th>
                                            </tr>
                                            </thead>
                                            <tbody>
