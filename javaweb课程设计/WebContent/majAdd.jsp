        ...
        <div class="content">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                        <form action="MajAdd" class="form" method="post" >
                                ...
                                <div class="col-md-8">
                           			<div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">专业ID</span>
                                            </div>
                                            <input type="text" name="majId" class="form-control" value="">
                                    </div>
                                    <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">专业名称</span>
                                            </div>
                                            <input type="text" name="majName" class="form-control" value="">
                                    </div>
