                                ...
                                <div class="col-md-8">
                           			<div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">书籍ID</span>
                                            </div>
                                    ...
                                    <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="bookAuthor" class="form-control" value="">
                                    </div>
                                    <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">书籍简介</span>
                                            </div>
                                            <input type="text" name="bookInfo" class="form-control" value="">
                                    </div>
                                    <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">所属课程</span>
                                            </div>
                                            <input type="text" name="bookSub" class="form-control" value="">
                                    </div>
                                    <div class="input-group mb-3">
                                            <div class="input-group-prepend">
