...
<head>
	...
	function add() {
		window.location.href='majAdd.jsp';
	}
	
	function deleteIt(str){
		if(confirm("确认删除此专业？"))
			window.location.href='MajDelete?majId=' + str;
		else
			return;
	}
</script>
...
<div class="page-wrapper">
    ...
    <div class="main-container">
        ...
        <div class="content">
            <div class="container">
             <form name="frm" action="MajManage">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
							...
							<c:forEach items="${listSch }"	var="item">	
                                ...
                                <div class="col-md-3">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="majName" class="form-control" value="${majName }">
                                    </div>
                                </div>
                                ...
                                <button type="button" class="btn btn-info" onclick="add()"> 新增专业</button>
                                ...
                                <div class="row p-1">
                                    <div class="col-md-12">
                                        <table class="table">
                                            <thead>
                                            <tr>
                                                <th class="border-0 text-uppercase small font-weight-bold">专业ID</th>
                                                <th class="border-0 text-uppercase small font-weight-bold">专业名称</th>
                                            </thead>
                                            <tbody>
                                            <c:forEach items="${majList }"	var="bean">		
					<tr>
						<td>${bean.majId }</td>	
						<td>${bean.majName}</td>
						<td><a class="btn btn-danger" href='javascript:deleteIt(${bean.majId})'>删除</a></td>
					</tr>
											</c:forEach>
                                            </tbody>
                                        </table>
