                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <c:forEach items="${list }" var="bean">
                                        ...
                                        <tr>
                                            <td>${bean.subName }</td>
                                            <td><a href='FollowDel?subId=${bean.subId}'>删除 </a>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
                            ...
                            <table class="table table-striped">
                                ...
                                <c:forEach items="${BKlist }" var="bean">
                                    ...
                                    <tr>
                                        <td>${bean.bookName}</td>
                                        <td></td>
                                        <td><a href='FollowDel?subId=${bean.bookId}'>收藏 </a>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
    ...
    <%--<div id="rightDiv">--%>
        <%--<div id="searchBox">--%>
            <%--<form name="frm" action="">--%>
                <%--&lt;%&ndash;文件标题：<input type="text" name="title" value="<c:out value="${title}"></c:out>">&ndash;%&gt;--%>
                <%--&lt;%&ndash;来源：<input type="text" name="source" value="${(bean.source==null?"":bean.source)}">&ndash;%&gt;--%>
                <%--&lt;%&ndash;起始时间：<input type="text" name="create_date" value="${(bean.create_date==null?"":bean.create_date)}">&ndash;%&gt;--%>
                <%--&lt;%&ndash;&lt;%&ndash;所在城市：<select name="city">&ndash;%&gt;&ndash;%&gt;--%>
                <%--&lt;%&ndash;&lt;%&ndash;<option value="">请选择</option>&ndash;%&gt;&ndash;%&gt;--%>
                <%--&lt;%&ndash;&lt;%&ndash;<option value="南昌" <%=("南昌".equals(city)?"selected":"") %>>南昌</option>&ndash;%&gt;&ndash;%&gt;--%>
                <%--&lt;%&ndash;&lt;%&ndash;<option value="成都" <%=("成都".equals(city)?"selected":"") %>>成都</option>&ndash;%&gt;&ndash;%&gt;--%>
                <%--&lt;%&ndash;&lt;%&ndash;</select>&ndash;%&gt;&ndash;%&gt;--%>

                <%--&lt;%&ndash;<input type="submit" value=" 查找 " />&ndash;%&gt;--%>
        ...
        <%--</div>--%>
        <%--<div id="toolbar" style="text-align:right;margin-right:10px;">--%>
            <%--<input type="button" value=" 添加关注 " onclick="add()" />--%>
        <%--</div>--%>
        <%--<div id="dataArea">--%>
